    ...
    <div className="pt-32 pb-24 px-6 min-h-screen flex items-center justify-center bg-gray-50">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 mt-2">Join our community of minimalist lovers</p>
        </div>
        ...
        <p className="text-center mt-8 text-sm text-gray-500">
          Already have an account? <Link to="/login" className="font-bold text-black hover:text-emerald-600 transition-colors">Sign in</Link>
        </p>
      </motion.div>
    </div>
  );
